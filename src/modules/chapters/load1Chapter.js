// src/modules/chapters/load1Chapter.js
...
export function load1Chapter(map) {
  const chapterName = "load1Chapter";
  const sourceId = chapterName + "_source";
  const layerId = chapterName + "point_layer";
  const iconID = chapterName + "icon";
  const LinedataPath = "datasets/2025_project-01/pathCoord.geojson";
  const PointdataPath = "datasets/2025_project-01/data.geojson";
  const dataName = "load1Chapter";
  const color = "#000000";
